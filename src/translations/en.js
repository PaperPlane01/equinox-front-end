export default {
    ...
    unblockUser_withUsername: "Unblock user {username}",
    unblockUserConfirmation: "Are you sure you want to unblock this user?",
    errorWhenAttemptedToUnblockUser: "Error occurred when attempted to unblock user. Server responded with {errorStatus} status. Please try again later",
    ...
    usersBlockedGlobally: "Users blocked globally",
    globalBlockings: "Global blockings",
    errorWhenAttemptedToFetchGlobalBlockings: "Error occurred when attempted to fetch global blockings. Server responded with {errorStatus} status. Please try again later",
    includeNotEndedBlockingsOnly: "Show not ended blockings only",
    errorWhenAttemptedToFetchGlobalBlocking: "Error occurred when attempted to fetch global blocking. Server responded with {errorStatus} status. Please try again later",
    errorWhenAttemptedToUpdateGlobalBlocking: "Error occurred when attempted to update global blocking. Server responded with {errorStatus} status. Please try again later",
    updateGlobalBlocking: "Update global blocking",
    updateGlobalBlocking_withUsername: "Update global blocking of {username}",
    endDate: "End date",
    dateShouldNotBeBeforeMinimalDate: "Date should not be before minimal date",
    globalBlockingUpdatedSuccessfully: "Global blocking has been updated successfully",
    deleteGlobalBlocking: "Delete global blocking",
    deleteGlobalBlocking_withUserName: "Delete global blocking of {username}",
    confirmGlobalBlockingDeletion: "Are you sure that you want to delete this global blocking?",
    errorWhenAttemptedToLogInWithGoogle: "Error occurred when attempted to log in with Google. Server responded with {errorStatus} status. Please try again later",
    loggingInWithGoogle: "Logging in with Google. It may take some time",
    ...
    spam: "Spam",
    SPAM: "Spam",
    websiteRulesViolation: "Website rules violation",
    WEBSITE_RULES_VIOLATION: "Website rules violation",
    ...
    report: "Report",
    errorWhenAttemptedToReportComment: "Error occurred when attempted to report comment. Server responded with {errorStatus} status. Please try again later",
